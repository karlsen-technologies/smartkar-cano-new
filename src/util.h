...
#define SECONDS(x) 1000L * (unsigned long)x
#define MINUTES(x) (unsigned long)(SECONDS(x) * 60L)
#define HOURS(x) (unsigned long)(MINUTES(x) * 60L)
#define DAYS(x) (unsigned long)(HOURS(x) * 24L)

#define as_micros(x) (unsigned long)(x * 1000L)

unsigned long millis_since(unsigned long);
